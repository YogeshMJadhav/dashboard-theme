  ...
  <UikLayoutMain contentLeft>
    ...
    <UikWidgetDoc margin>
      ...
      <UikWidgetContent>
        ...
        <p>
            For a server configuration, you can explore
          {' '}
          <code>
            src/server/*
          </code>
          {' '}
          files. By default, the code is not server side rendered, however you can use an example for SSR included in this project.
        </p>
        <h3>
          Redux
        </h3>
